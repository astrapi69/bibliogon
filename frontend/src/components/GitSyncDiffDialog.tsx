        ...
        >
          <div className="dialog-header">
            <Dialog.Title className="dialog-title">
              ...
              />
              {t(
                "ui.git_sync.diff_title",
                "Änderungen vom Repo zusammenführen",
              )}
            </Dialog.Title>
            <Dialog.Close
            ...
            <>
              ...
              <div className="dialog-footer">
                ...
                >
                  ...
                  {t("ui.git_sync.diff_apply", "Auflösungen anwenden")}
                </button>
              </div>
            </>
          )}
      ...
      <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
        ...
        {chapter.classification === "both_changed" && (
          <button
            type="button"
            className={`btn btn-sm ${
              action === "mark_conflict" ? "btn-primary" : "btn-secondary"
            }`}
...
function ClassificationBadge({
  ...
  const label = (() => {
    switch (classification) {
      ...
      case "local_changed":
        return t("ui.git_sync.diff_label_local_changed", "Bibliogon geändert");
      case "both_changed":
        return t("ui.git_sync.diff_label_both_changed", "Konflikt");
      case "remote_added":
        return t("ui.git_sync.diff_label_remote_added", "Repo neu");
      case "local_added":
        return t("ui.git_sync.diff_label_local_added", "Bibliogon neu");
      case "remote_removed":
        return t("ui.git_sync.diff_label_remote_removed", "Im Repo gelöscht");
      case "local_removed":
        return t(
      ...
      case "renamed_remote":
        return t("ui.git_sync.diff_label_renamed_remote", "Im Repo umbenannt");
      case "renamed_local":
        return t(
