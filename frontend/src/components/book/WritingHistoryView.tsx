...
export default function WritingHistoryView() {
    const { t } = useI18n();
    const csv = useFeature(FEATURES.WRITING_HISTORY_CSV);
    ...
    const reload = useCallback(async () => {
        ...
        try {
            ...
            notify.error(
                t("ui.writing_stats.load_failed", "Schreibverlauf konnte nicht geladen werden."),
            );
        } finally {
            setLoading(false);
        }
    ...
    const toggleBook = async (bookId: string) => {
        ...
        try {
            ...
            notify.error(
                t("ui.writing_stats.chapters_failed", "Kapitel-Aufschlüsselung fehlgeschlagen."),
            );
        }
    };
    ...
    return (
        <div data-testid="writing-history-view">
            ...
            {loading ? (
                ...
                <>
                    <div className={styles.summaryCards} data-testid="writing-history-summary">
                        <SummaryCard
