          ...
          <Tabs.Root value={mode} onValueChange={(v) => setMode(v as Mode)}>
            ...
            <Tabs.Content value="template">
              <div className={styles.templatePickerHeader}>
                <div className="label">
                  {t(
                    "ui.create_book.template_picker_title",
                    "Wähle eine Vorlage",
                  )}
                </div>
              </div>
                ...
                <div className={styles.detailsSection}>
                  ...
                  <div className="field">
                    ...
                    <input
                      ...
                      placeholder={t(
                        "ui.create_book.subtitle_placeholder",
                        "Optional",
                      )}
                    />
                  </div>
                    ...
                    <div className={styles.row}>
                      ...
                      <div className="field" style={{ flex: 1 }}>
                        ...
                        <input
                          ...
                          placeholder={t(
                            "ui.create_book.volume_placeholder",
                            "Nr.",
                          )}
                        />
                      </div>
