/**
 * Writing-History view (WRITING-HISTORY-STATS-01).
 *
 * The full counterpart to the daily-goal WritingGoalWidget: a window of
 * writing history with summary stats, a per-day bar chart (recharts),
 * a per-book breakdown that drills into per-chapter totals, and a CSV
 * export. Data from /api/writing-stats/* (global + per-book/chapter).
 */
...
import styles from "./WritingHistoryModal.module.css";
...
export default function WritingHistoryModal({ open, onClose }: Props) {
  const { t } = useI18n();
        ...
        >
          <div className={styles.header}>
            <Dialog.Title className={styles.title}>
              ...
              {t("ui.writing_stats.title", "Schreibverlauf")}
            </Dialog.Title>
            ...
            <>
              ...
              {summary.daily.length > 0 ? (
                <div
                  ...
                  data-testid="writing-history-chart"
                >
              ...
              {books && books.length > 0 ? (
                <div
                  className={styles.byBook}
                  data-testid="writing-history-by-book"
                >
                      ...
                      <li key={book.book_id} className={styles.bookItem}>
                        ...
                        >
                          ...
                          <span
                            ...
                            aria-hidden
                          />
                          <span className={styles.bookWords}>
                            {book.total_words}
                          </span>
                        </button>
