        ...
        >
          <div className="dialog-header">
            <Dialog.Title className="dialog-title icon-row">
              <Bug size={18} />{" "}
              {t("ui.error_report.title", "Issue-Report erstellen")}
            </Dialog.Title>
          </div>
          ...
          >
            ...
            >
              ...
              />
              {t(
                "ui.error_report.include_env",
                "Umgebungsinformationen (Version, Browser, OS)",
              )}
            </label>
            <label
              style={{
            ...
            >
              ...
              />
              {t("ui.error_report.include_history", "Aktions-Historie")} (
          ...
          >
            {t(
              "ui.error_report.privacy",
              "Keine Buch-Inhalte, keine Passwörter, keine Lizenz-Keys werden jemals gesendet.",
            )}
          </p>
          ...
          <div className="dialog-footer">
            ...
            >
              <Bug size={14} />{" "}
              {t("ui.error_report.submit", "Issue auf GitHub erstellen")}
            </button>
          </div>
        </Dialog.Content>
      </Dialog.Portal>
