 ...
 * data lifecycle, asset-URL resolution (api + dexie), the
 * grid-template overflow handler, and the full panel/bubble CRUD +
 * drag + cross-page-move set; the component consumes the returned bag
 * and renders the header + 3-column body. Logic is byte-identical to
