...
Latest release: v0.41.0 (2026-05-30) — see [ROADMAP.md](ROADMAP.md) and [changelog/releases/v0.41.0.md](../changelog/releases/v0.41.0.md).

Last updated: 2026-05-30 (v0.41.0 release cut — UX/UI theme + accessibility hardening (12-variant audit, undefined-token + contrast fixes, `make verify-theme` gate), per-content-type field visibility, and a documentation refresh. No active-backlog closures beyond the shipped features; counts unchanged. P3=17, P5=12, Total active 57.)
