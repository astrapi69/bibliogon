...
Latest release: v0.40.0 (2026-05-29) — see [ROADMAP.md](ROADMAP.md) and [changelog/releases/v0.40.0.md](../changelog/releases/v0.40.0.md).

Last updated: 2026-05-29 (v0.40.0 release cut — COMIC-PANEL-CROSS-PAGE-MOVE-01 shipped (8-commit arc) + a comprehensive doc-update pass; new `verify-docs-completeness` release gate. No active-backlog closures beyond the comic-panel feature; counts unchanged. P3=17, P5=12, Total active 57.)
