...
#
# Moved here from routes.py during C4 (KDP-PUBLISHING-WIZARD-01 Phase 1)
# to break a routes.py <-> package.py circular import. The constant
# belongs next to validate_cover() which is its primary consumer.
